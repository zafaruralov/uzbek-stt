#!/usr/bin/env python3
"""Gradio server for Uzbek ASR v1.1 best-checkpoint model."""
...
MODEL_PATH = "/root/stt/v2_pipeline/models/uzbek_v11_molxona_cfgh/best_epoch7_model.nemo"
PORT = 7867

print("Loading NeMo v1.1 best-checkpoint model...")
...
demo = gr.Interface(
    ...
    title="Uzbek ASR v1.1 (Best Checkpoint)",
    description=(
        "Model: uzbek_v11_molxona_cfgh best checkpoint (epoch 7). "
        "Use this to compare against older 7865/7866 services."
    ),
)
